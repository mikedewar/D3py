...
class PandasFigure(Figure):
    def __init__(self, data, name="figure", width=800, height=400,
        ...
        use_index: boolean, default False
            If true, D3py.Vega uses the index for the x-axis instead of a
            second column
        interactive : boolean
        ...
        super(PandasFigure, self).__init__(
            name=name, width=width, height=height, interactive=interactive,
